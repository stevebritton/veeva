    ...
    return when.promise(function(promiseResolve, promiseReject) {
        ...
        if (cliArgs.version) {
            ...
            if (options.deploy.keyMessage) {
                ...
                var arrMergeKeyMessages = options.clm.key_messages.concat(options.hiddenKeyMessages),
                    indexKeyMessageExists;

                var arrMergeKeyMessageNames = arrMergeKeyMessages.map(function(e) {
                    return e && e.key_message ? e.key_message : false;
                });

                indexKeyMessageExists = arrMergeKeyMessageNames.indexOf(options.deploy.keyMessage.toString());
